            ...
            <form className="space-y-4">
              ...
              <div className="*:not-first:mt-2">
                ...
                <div className="flex rounded-md shadow-xs">
                  <span
                    className="-z-10 inline-flex items-center rounded-s-md border border-input bg-background px-3 text-muted-foreground text-sm">
                    https://
                  </span>
                  <Input
...
function ProfileBg() {
  ...
  return (
    <div className="h-32">
      <div
        className="relative flex size-full items-center justify-center overflow-hidden bg-muted">
        {currentImage && (
          <img
            alt={
              files[0]?.preview
...
function Avatar() {
  ...
  return (
    <div className="-mt-10 px-6">
      <div
        className="relative flex size-20 items-center justify-center overflow-hidden rounded-full border-4 border-background bg-muted shadow-black/10 shadow-xs">
        {currentImage && (
          <img
            alt="Profile"
            className="size-full object-cover"
